          ...
          <div className="max-w-6xl mx-auto px-4 pb-20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                { id: 'detail-3', title: 'Doing the Dishes', img: 'https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?q=80&w=800&auto=format&fit=crop', desc: 'Rinse and sanitize dishes, cutting boards, and cutlery naturally using Strong Acidic Water (pH 2.5).' },
                ...
                { id: 'detail-6', title: 'Kangen Water® Liquid Castile Cleaner', img: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?q=80&w=800&auto=format&fit=crop', desc: 'Castile soap infused with Kangen Water provides multi-surface cleaning power for counters, floors, and sinks.' },
      ...
      {activePage === 'food' && (
        <div className="bg-white">
          ...
          <div className="max-w-6xl mx-auto px-4 pb-20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { id: 'food-detail-1', title: 'Best Produce', img: 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?q=80&w=800&auto=format&fit=crop', desc: 'Buying local and organic produce ensures fresher, healthier food while reducing exposure to pesticides and GMOs.' },
                ...
                { id: 'food-detail-4', title: 'Kangen Tea', img: 'https://images.unsplash.com/photo-1597481499750-3e6b22637e12?q=80&w=800&auto=format&fit=crop', desc: 'Infuse tea effortlessly! Kangen Water\'s micro-clustered molecules penetrate tea leaves quickly even with cold or room-temp water.' },
          ...
          <div className="max-w-6xl mx-auto px-4 pb-20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                { id: 'beauty-detail-3', title: 'A New Approach to Skin Care', img: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&w=800&auto=format&fit=crop', desc: 'Replacing harsh chemical astringents with Kangen Beauty Water® keeps skin clean, hydrated, and youthful.' },
                { id: 'beauty-detail-4', title: 'Be Green, Be Ravishing!', img: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?q=80&w=800&auto=format&fit=crop', desc: 'To have a routine that keeps you healthy and hydrated can make you feel beautiful inside and out!' },
                ...
                { id: 'beauty-detail-7', title: 'Beauty Water Lotion', img: 'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?q=80&w=800&auto=format&fit=crop', desc: 'Nourish dry skin with a soothing, fast-absorbing body lotion crafted with Kangen Beauty Water®.' },
                { id: 'beauty-detail-8', title: 'Enagic Non-Toxic Hand Sanitizer Recipe', img: 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?q=80&w=800&auto=format&fit=crop', desc: 'Have you ever investigated what is in your antibacterial products? Try our natural Strong Acidic Water recipe instead.' },
          ...
          <div className="max-w-6xl mx-auto px-4 pb-20">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                ...
                { id: 'pet-detail-2', title: 'Getting Rid of Pet Odors the Green Way', img: 'https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?q=80&w=800&auto=format&fit=crop', desc: 'Tackle pet odors, upholstery stains, bad breath, and toy sanitation using chemical-free Enagic® water solutions.' },
                { id: 'pet-detail-3', title: 'Homemade Kangen Water® Pet Shampoo', img: 'https://images.unsplash.com/photo-1516734212186-a967f81ad0d7?q=80&w=800&auto=format&fit=crop', desc: 'Formulate a gentle, chemical-free pet shampoo with glycerine, Enagic® soap, and Kangen Water® for a shiny, soft coat.' },
