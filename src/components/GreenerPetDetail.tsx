...
const INITIAL_COMMENTS: Comment[] = [
  ...
  },
  {
    ...
    date: 'Nov 19, 2025',
    text: '★ ★ ★ ★ ★ Our rescue cat used to barely drink water until we filled her pet fountain with Neutral 7.0 pH Kangen Water. Her energy levels are fantastic now! Our distributor was so wonderful during consultation.',
    likes: 16,
    avatarBg: 'bg-[#3E4C4C]',
  },
];
